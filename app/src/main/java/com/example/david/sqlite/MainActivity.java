        ...
        addProductButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ( newName.isEmpty() || quantity < 0 ) {
                    Toast.makeText(MainActivity.this, "Please enter a product name and numerical" +
                            " quantity", Toast.LENGTH_LONG).show();
                    return;
                }

                if (dbManager.addProduct(newName, quantity)) {
                    Toast.makeText(MainActivity.this, "Product added to database",
                    ...
                    Toast.makeText(MainActivity.this, newName +" is already in the database",
                            Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        searchProductsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ( searchName.isEmpty()) {
                    Toast.makeText(MainActivity.this, "Please enter a product to search for",
                            Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if (quantity == -1) {
                    //Product not found
                    Toast.makeText(MainActivity.this, "Product " + searchName + " not found",
                            Toast.LENGTH_LONG).show();
                } else {
        ...
        updateQuantityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ( productName.isEmpty() || newQuantity < 0) {
                    Toast.makeText(MainActivity.this, "Please enter a numerical quantity and a product name", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if ( dbManager.updateQuantity(productName, newQuantity) ){
                    Toast.makeText(MainActivity.this, "Quantity updated", Toast.LENGTH_LONG).show();
                    allProductListAdapter.changeCursor(dbManager.getCursorAll());
                } else {
                    Toast.makeText(MainActivity.this, "Product not found in database", Toast.LENGTH_LONG).show();
                }
            }
        });
                ...
                new AlertDialog.Builder(MainActivity.this)
                        ...
                        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(MainActivity.this, "Product deleted", Toast.LENGTH_LONG).show();
                                allProductListAdapter.changeCursor(dbManager.getCursorAll());
